...
//        작성일시의 일시값을 그대로 복사 (원래값: 현재일시)
        localCal.time = this.createAt.time

//        localCal의 값을 내 폰 설정에 맞게 시간을 더하자.
//        ex.한국: +9를 더해야함.
//        ex.LA: -8을 더해야함.

//        Calendar 객체의 기능으로, 시간대 정보를 추출
...
//        ex. 2분전 작성=> "2분 전"
//        ex. 5일전 작성 => "4월 5일 오전 5시 6분"
        val now = Calendar.getInstance() //현재시간 표현변수(핸드폰 시간대가 적용되어 있음)
...
//            24시간 이내: ? 시간 전
            val diffHour = timeAgo/ 1000 / 60 / 60
